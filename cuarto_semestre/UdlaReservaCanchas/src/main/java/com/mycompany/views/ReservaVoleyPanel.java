 ...
 * @author dell-pc
 */
public class ReservaVoleyPanel extends javax.swing.JPanel {
    private boolean isAdmin;
    private String idBanner;
    /**
     * Creates new form reservaPanel
     */
    public ReservaVoleyPanel(boolean isAdmin, String idBanner) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tittle.setText("Reservar canchas - Cancha de Volleyball");

        heroImg.setBackground(new java.awt.Color(153, 153, 255));
        heroImg.setForeground(new java.awt.Color(102, 102, 255));
        heroImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/vol (1).jpg"))); // NOI18N
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(bgLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(tittle, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void hacerReservaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hacerReservaBtnActionPerformed
        ...
        if (numCanchaSpin.getSelectedItem() == "Cancha 1") {
            reserva.setCanchaID(5);
        } else {
            reserva.setCanchaID(6);
        }
