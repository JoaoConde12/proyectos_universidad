 ...
 * @author dell-pc
 */
public class ReservaRugbyPanel extends javax.swing.JPanel {
    private boolean isAdmin;
    private String idBanner;
    /**
     * Creates new form reservaPanel
     */
    public ReservaRugbyPanel(boolean isAdmin, String idBanner) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tittle.setText("Reservar canchas - Cancha de Rugby");

        heroImg.setBackground(new java.awt.Color(153, 153, 255));
        heroImg.setForeground(new java.awt.Color(102, 102, 255));
        heroImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/tug (1).jpg"))); // NOI18N
